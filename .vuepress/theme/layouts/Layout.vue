<template>
  ...
  >
    ...
    <ExtraSidebar v-if="shouldShowExtraSidebar" />
...
import ExtraSidebar from '@theme/components/ExtraSidebar.vue'
import Footer from '@theme/components/Footer.vue'
import { resolveSidebarItems } from '@theme/util'

export default {
  components: { Home, Page, Sidebar, Navbar, ExtraSidebar, Footer },
  ...
  computed: {
    ...
    shouldShowExtraSidebar () {
      return !this.$page.frontmatter.home && this.$page.frontmatter.sidebar !== false
    },
  ...
  mounted () {
    this.$router.afterEach(() => { this.isSidebarOpen = false })
  },
